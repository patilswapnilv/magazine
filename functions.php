...
// Add a filter to cp_base_header_image_width and cp_base_header_image_height to change these values.
define( 'HEADER_IMAGE_WIDTH', apply_filters( 'cp_base_header_image_width', 940 ) );
define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'cp_base_header_image_height', 200 ) );
...
add_custom_image_header('cp_mag_header_style', 'cp_mag_admin_header_style');
